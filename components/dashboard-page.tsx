...
export function DashboardPage() {
  ...
  const handleAddAccount = () => {
    ...
    if (!newAccountSize || isNaN(Number.parseFloat(newAccountSize)) || Number.parseFloat(newAccountSize) <= 0) {
      toast({
  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden">
      <Sidebar activePage="dashboard" showMobile={showMobileMenu} onClose={() => setShowMobileMenu(false)} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {selectedAccountId ? (
                    ...
                    <div className="lg:col-span-2 p-6 bg-gray-900 border border-gray-800 rounded-lg text-center transition-all duration-300">
                      ...
                      <p className="text-gray-400">Please select an account from the sidebar to view your dashboard</p>
                    </div>
                  )}
                </div>
              </>
